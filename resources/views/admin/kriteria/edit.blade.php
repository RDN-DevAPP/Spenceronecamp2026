...
@section('title', 'Edit Kriteria: ' . $kriteria->nama_kriteria . ' - Admin LTI 2026')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-2">
                ...
                <span class="text-scout-primary/50 text-sm">/</span>
                <span class="text-scout-primary text-sm font-bold">Edit</span>
            </div>
            ...
            <form action="{{ route('admin.kriteria.update', $kriteria->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" min="0" name="nilai_min" id="nilai_min"
                                value="{{ old('nilai_min', $kriteria->nilai_min) }}" required
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" min="0" name="nilai_max" id="nilai_max"
                                value="{{ old('nilai_max', $kriteria->nilai_max) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $kriteria->urutan) }}"
                            min="0"
