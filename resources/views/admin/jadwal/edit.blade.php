...
@section('title', 'Edit Jadwal - Admin LTI 2026')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-2">
                ...
                <span class="text-scout-primary text-sm font-bold">Edit Agenda</span>
            </div>
            <h1 class="text-3xl font-bold text-scout-primary flex items-center gap-3">
                <i data-lucide="calendar-range" class="w-8 h-8 text-scout-accent"></i>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="hari_ke" id="hari_ke" value="{{ old('hari_ke', $jadwal->hari_ke) }}"
                                min="1" required
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', $jadwal->tanggal) }}"
                                required min="{{ $settings['event_start_date'] ?? '' }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="time" name="waktu_selesai" id="waktu_selesai"
                                value="{{ old('waktu_selesai', $jadwal->waktu_selesai ? substr($jadwal->waktu_selesai, 0, 5) : '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="kegiatan" id="kegiatan" value="{{ old('kegiatan', $jadwal->kegiatan) }}"
                            required
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $jadwal->lokasi) }}"
