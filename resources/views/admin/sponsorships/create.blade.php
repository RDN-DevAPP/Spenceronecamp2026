...
@section('title', 'Tambah Sponsor - Admin')

@section('content')
    <div class="py-12 bg-gray-100 min-h-screen">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Tambah Sponsor Baru</h1>
                ...
                <form action="{{ route('admin.sponsorships.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="logo" id="logo" class="mt-1 block w-full text-sm text-gray-500
                            ...
                            hover:file:bg-scout-primary/90" required accept="image/*">
                        <p class="mt-1 text-sm text-gray-500">Format: JPG, PNG, GIF, SVG. Max 2MB.</p>
                    </div>
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <button type="submit"
                            class="bg-scout-primary text-white px-4 py-2 rounded-md hover:bg-scout-primary/90 transition shadow-md">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
